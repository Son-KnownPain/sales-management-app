 ...
 * @author PC HP
 */
public class EnterDiscountValue extends javax.swing.JDialog {
    private ImportView importView = null;

    public EnterDiscountValue(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(225, 244, 255));
        ...
        jLabel1.setText("Enter Discount Value");

        jButton1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jButton1.setText("Comfirm");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                handleConfirmDiscount(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(inputValue, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnterDiscountValue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
